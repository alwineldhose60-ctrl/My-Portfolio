        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 lg:gap-24">
            ...
            <div className="relative border-l border-zinc-800 pl-8 ml-3 space-y-12">
              ...
              <div className="relative">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed font-light">
                  Optimizing Next.js SSR performance and developing full-stack
                  features with FastAPI backends. Leading agile front-end
                  initiatives.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed font-light">
                  Assisted in API integrations and mastered Next.js framework
                  fundamentals under strict mentorship.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-xs font-bold tracking-widest text-[#e2e8f0] uppercase">
                  Buffaload AI
                </h4>
